...
- AWS_REGION:   
the AWS region you want the server to be hosted in, currently  Singapore `ap-southeast-1` is supported by the script unless you want to update the scripts manually to consider a different value.
